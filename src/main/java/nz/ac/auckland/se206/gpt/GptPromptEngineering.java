...
public class GptPromptEngineering {
  ...
  public static String getRiddleWithGivenWord(String wordToGuess) {
    ...
    return "Tell me a difficult riddle with answer: "
        + wordToGuess
        + ". Act like a wise mystical tree of a forest. You should answer with the word 'Correct'"
        + " when is correct. If the answer is incorrect, you should say it is incorrect. You"
  ...
  public static String introCall() {
    return "Act like a wise mystical tree of a forest. Greet me.";
  }
